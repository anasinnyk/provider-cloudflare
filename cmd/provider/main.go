...
import (
	...
	"github.com/crossplane/provider-cloudflare/apis/v1alpha1"
	cloudflare "github.com/crossplane/provider-cloudflare/internal/controller"
...
func main() {
	...
	kingpin.FatalIfError(cloudflare.Setup(mgr, o), "Cannot setup Cloudflare controllers")
