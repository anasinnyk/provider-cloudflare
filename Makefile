...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Cloudflare CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Cloudflare controllers
...
# This target prepares repo for your provider by replacing all "cloudflare"
